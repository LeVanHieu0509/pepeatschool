---
title: Telemetry
description: PEPE AT SCHOOL collects anonymous telemetry data about general usage. Participation is optional, and you may opt-out at any time.
---

# Telemetry

PEPE AT SCHOOL collects anonymous telemetry data about general usage. Participation is optional, and you may opt-out at any time.
...
We track general usage information about PEPE AT SCHOOL and different configuration options that we support. Specifically, we track the following anonymous data:

- Initializing a new project (`npx million@latest`)
- PEPE AT SCHOOL version
...
The data collected by PEPE AT SCHOOL is completely anonymous and only meaningful in aggregate form. The data that we store is not traceable to the source, and is only available to a small subset of the PEPE AT SCHOOL core maintainer team to help inform our roadmap prioritization.

PEPE AT SCHOOL does not track, collect, or store personally identifiable information (PII). The telemetry data that we do track has never and will never be sold or monetized in any form.
