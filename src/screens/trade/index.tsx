      ...
      <div className="Main">
        <div className="Main-title">
          <div className="pepetitle-and-logo">
            ...
            <img src="/img-logo/settings-gears.png" className="pepetitle-logo"></img>
          </div> 
        ...
        <div className="prediction_section ">
          <div className="eighty-percent-section">
            <div className="prediction_headline">Dự báo thị trường tuần này</div>
            <div className="red-condition_prediction">
              <div className="down_prediction">Giảm</div>
              <img src="/img-logo/pepe-crew-img.png" className="down-img_prediction"></img>
            </div>
          ...
          <div className="twenty-precent-section">
            <div className="prediction_risk_part ">
              <div className="prediction_risk_headline bold sm-text margin-bot">Tỉ lệ rủi ro</div>
              <div className="prediction_risk_data red800 bold margin-bot">35.63%</div>

            </div>
            <div className="prediction_risk_change">
            <div className="prediction_risk_change_headline bold sm-text margin-bot">Tỉ lệ rủi ro thay đổi</div>
              <div className="prdiction_risk_change_data red800 bold margin-bot">1.75%</div>
            </div>
            <Button className="btn_more_info bold">
              Xem thêm
            </Button>
        ...
        <div className="ai-section">
          <div className="ai_ask_title_part">
            ...
            <img
                ...
                alt=""
              /> 
            <div className="ai_title bold">Pepe AI
          ...
          <div className="ask_ai_section">
            ...
            <input className="ask_ai_box" placeholder="Nhập câu hỏi ở đây" type="text" > 
            </input>
